			...
			<div class="col-lg-8  mb-5 mb-lg-0">
				<article class="row mb-5">
					...
					<div class="col-12 mx-auto">
						<h3><a class="post-title" href="post-elements.html">Selamat Datang di web terpadu Babakan</a></h3>
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <small class="text-muted" _msthash="2662946" _msttexthash="75751" style="direction: ltr; text-align: left;">9 menit</small>
                            </div>
                        </div>
                    </div>
				</article>
