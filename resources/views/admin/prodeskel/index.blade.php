              ...
              <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                <li class="nav-item">
                  <div class="col-6 text-end">
                    <a class="btn bg-gradient-primary mb-0" href="/admin/prodeskel/form"><i class="fas fa-plus"></i>&nbsp;&nbsp;Add New</a>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div class="card h-100">
            ...
            <table class="table align-items-center mb-0">
                ...
                <tr>
                    ...
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Nama Kepala Keluarga</th>
                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nama Pengisi</th>
                ...
                <tr>
                    ...
                    <td>
                        <p class="text-xs font-weight-bold mb-0">Rinal</p>
                    </td>                    
                    <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">Irul</span>
                    </td>
