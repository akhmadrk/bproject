          ...
          <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-keluarga" role="tabpanel" aria-labelledby="nav-home-tab">
              <div class="row mt-3">
                ...
                <div class="col-6 text-end">
                  <a class="btn btn-outline-primary mb-0" href="/prodeskel/keluarga"><i class="fas fa-plus"></i>&nbsp;&nbsp;Add New</a>
                </div>
              </div>
              <div class="border-0 d-flex p-4 mt-4 bg-gray-100 border-radius-lg">
                ...
                <div class="ms-auto text-end">
                  <a class="btn btn-link text-danger text-gradient px-3 mb-0" data-bs-target="#kelDel" data-toggle="modal" href="#kelDel"><i class="far fa-trash-alt me-2"></i>Delete</a>
                  <a class="btn btn-link text-dark px-3 mb-0" data-target="#kelEdit" data-toggle="modal" href="#kelEdit"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit</a>
                </div>
              </div>
            </div>
            <div class="tab-pane fade" id="nav-anggota" role="tabpanel" aria-labelledby="nav-profile-tab">
              <div class="row mt-3">
                ...
                <div class="col-6 text-end">
                  <a class="btn btn-outline-primary mb-0" href="/prodeskel/anggota"><i class="fas fa-plus"></i>&nbsp;&nbsp;Add New</a>
                </div>
              </div>
              <div class="border-0 d-flex p-4 mt-4 bg-gray-100 border-radius-lg">
                <div class="d-flex flex-column">
                  <h6 class="mb-3 text-sm">1 Junaidi</h6>
                  <span class="mb-2 text-xs">Nomor Induk Kependudukan: <span class="text-dark font-weight-bold ms-sm-2">198097032</span></span>
                ...
                <div class="ms-auto text-end">
                  <a class="btn btn-link text-danger text-gradient px-3 mb-0" data-target="#angDel" data-toggle="modal" href="#angDel"><i class="far fa-trash-alt me-2"></i>Delete</a>
                  <a class="btn btn-link text-dark px-3 mb-0" data-target="#angEdit" data-toggle="modal" href="#angEdit"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit</a>
                </div>
              </div>
            </div>
