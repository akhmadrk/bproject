...
<div class="container-fluid py-4">
    ...
    <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
        ...
        <div class="card-body p-3">
            ...
            <div class="col-8">
                <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Data Berita</p>
    ...
    <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
        ...
        <div class="card-body p-3">
            ...
            <div class="col-8">
                <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Data Galeri</p>
                <h5 class="font-weight-bolder mb-0">
                    20.000
                    </h5>
                </div>
    ...
    <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
        ...
        <div class="card-body p-3">
            ...
            <div class="col-8">
                <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Data Approval</p>
                <h5 class="font-weight-bolder mb-0">
                    5.000
                </h5>
                </div>
