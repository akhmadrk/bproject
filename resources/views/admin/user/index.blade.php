          ...
          <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
            <li class="nav-item">
              <div class="col-6 text-end">
                <a class="btn bg-gradient-primary mb-0" data-bs-toggle="modal" data-bs-target="#modalSave"><i class="fas fa-plus"></i>&nbsp;&nbsp;Add New</a>
              </div>
            </li>
          </ul>
        </div>
            ...
            <tbody>
              <tr>
                ...
                <td class="align-middle text-center text-sm">
                  <span class="badge badge-sm bg-gradient-success">Karyawan</span>
                </td>
              ...
              <tr>
                ...
                <td class="align-middle text-center text-sm">
                  <span class="badge badge-sm bg-gradient-secondary">Kontrak</span>
                </td>
                <td class="align-middle text-center">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header bg-gradient-primary">
        <h4 class="modal-title text-white">Form User</h4>
          ...
          <div class="card-body">
            <form role="form">
              ...
              <div class="mb-3">
                ...
                <option class="text-secondary opacity-3"> Pilih Role</option>
                  <option value="Manager">Manager</option>
                  <option value="Progamator">Progamator</option>
                </select>
              </div>
              <label>Alamat</label>
              <div class="mb-3">
